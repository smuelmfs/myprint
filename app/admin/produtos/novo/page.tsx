...
export default function NovoProdutoPage() {
  ...
  // Debug: Log quando o estado do modal muda (apenas em desenvolvimento)
  React.useEffect(() => {
    if (process.env.NODE_ENV === 'development') {
      console.log("🔍 Estado do modal mudou:", errorModal)
    }
  }, [errorModal])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        let errorTitle = "Erro ao criar produto"
        ...
        if (process.env.NODE_ENV === 'development') {
          console.log("🚨 Exibindo modal de erro:", { errorTitle, errorMessage, errorType })
        }
        
        // Mostrar toast também como fallback
        toast({
          title: errorTitle,
